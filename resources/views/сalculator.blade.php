...
@section('content')
    ...
    @endif
    {!! Form::open(['route'=>'cartridge.store', 'class'=>'form-horizontal', 'name'=>'Calculator']) !!}
    ...
    <div class="form-group hidden-print">
        <div class="col-sm-offset-3 col-sm-9">
            {!! Form::submit('Сохранить', ['class'=>'btn btn-success', 'id'=>'Calculator']) !!}
            {!! link_to_route('main', 'Отмена', null, ['class'=>'btn btn-danger'])!!}
        </div>
    </div>
    {!! Form::Close() !!}
@stop
