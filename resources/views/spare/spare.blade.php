...
@section('content')
    <div class="panel panel-default">
        <div class="panel-body">
            {!! Form::open(['route'=>'spare.order', 'class'=>'form-inline', 'method' => 'get']) !!}
        ...
        @if (! $messages->isEmpty() )
            ...
            @foreach($messages as $message)
                <tr>
                    ...
                    @endif
                    <th><a class="btn btn-primary btn-xs" href="spare/{!!$message->id!!}/show"><span class="glyphicon glyphicon-fullscreen"></span> Просм</a></th>
                    <th><a class="btn btn-primary btn-xs" href="spare/{!!$message->id!!}/printed"><span class="glyphicon glyphicon-print"></span> Печать</a></th>
                    <th><a class="btn btn-primary btn-xs" href="spare/{!!$message->id!!}/edit"><span class="glyphicon glyphicon-pencil"></span>  Ред</a></th>
                    <th><a class="btn btn-primary btn-xs" href="spare/{!!$message->id!!}/del"><span class="glyphicon glyphicon-trash"></span> Удл</a></th>
                </tr>
            @endforeach
